  ...
  const t = {
    ar: {
      ...
      permissionsList: [
        ...
        { name: 'المشاريع والمهام', required: false },
        { name: 'التقارير', required: false },
        { name: 'التحليلات', required: false },
        { name: 'المخزون', required: false },
    ...
    en: {
      ...
      permissionsList: [
        ...
        { name: 'Projects & Tasks', required: false },
        { name: 'Reports', required: false },
        { name: 'Analytics', required: false },
        { name: 'Inventory', required: false },
