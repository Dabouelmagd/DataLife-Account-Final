  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        ar ? 'قسيمة راتب بالبريد الإلكتروني' : 'Email payslips',
        ar ? 'إشعارات التحديثات التلقائية' : 'Auto update notifications',
    ...
    },
    {
      ...
      features: [
        ...
        ar ? 'تسجيل الحضور بالـ GPS' : 'GPS attendance check-in',
        ar ? 'قسيمة راتب بالبريد الإلكتروني' : 'Email payslips',
        ar ? '108 حساب محاسبي وفق الدليل المصري' : '108 accounts per Egyptian chart',
        ...
        ar ? 'محاسبة Enterprise (مستوى SAP)' : 'Enterprise accounting (SAP level)',
        ar ? 'إشعارات تحديثات النظام' : 'System update notifications',
        ar ? 'أمان متعدد الطبقات (HTTPS+JWT+Rate Limit)' : 'Multi-layer security (HTTPS+JWT+Rate Limit)',
      ],
      notIncluded: [],
    },
  ];
