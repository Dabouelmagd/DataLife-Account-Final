...
# CORS Configuration
CORS_ORIGINS="https://multi-tenant-erp-14.preview.emergentagent.com,http://localhost:3000,https://localhost:3000"
```

### Frontend Configuration (`/app/frontend/.env`)

```env
REACT_APP_BACKEND_URL=https://multi-tenant-erp-14.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
...
- https://multi-tenant-erp-14.preview.emergentagent.com (Production on Emergent)
