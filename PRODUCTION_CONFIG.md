...
# CORS Configuration
CORS_ORIGINS="https://landing-page-update-3.preview.emergentagent.com,http://localhost:3000,https://localhost:3000"
```

### Frontend Configuration (`/app/frontend/.env`)

```env
REACT_APP_BACKEND_URL=https://landing-page-update-3.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
...
- https://landing-page-update-3.preview.emergentagent.com (Production on Emergent)
