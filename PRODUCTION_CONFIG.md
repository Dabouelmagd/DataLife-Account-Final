...
# CORS Configuration
CORS_ORIGINS="https://datalife-erp.preview.emergentagent.com,http://localhost:3000,https://localhost:3000"
```

### Frontend Configuration (`/app/frontend/.env`)

```env
REACT_APP_BACKEND_URL=https://datalife-erp.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
...
- https://datalife-erp.preview.emergentagent.com (Production on Emergent)
