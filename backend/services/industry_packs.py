...
PACKS = {
    ...
    "construction": {
        "price_egp": 399,   # شهرياً فوق الاشتراك الأساسي
    ...
    # ── 2) التطوير العقاري ───────────────────────────────────────
    "real_estate": {
        "price_egp": 299,   # شهرياً فوق الاشتراك الأساسي
    ...
    # ── 3) التصنيع ───────────────────────────────────────────────
    "manufacturing": {
        "price_egp": 599,   # شهرياً فوق الاشتراك الأساسي
    ...
    # ── 4) الاستيراد ─────────────────────────────────────────────
    "import": {
        "price_egp": 349,   # شهرياً فوق الاشتراك الأساسي
    ...
    "restaurants": {
        "price_egp": 249,   # شهرياً فوق الاشتراك الأساسي
    ...
    # ── 12) التعليم ──────────────────────────────────────────────
    "education": {
        "price_egp": 199,   # شهرياً فوق الاشتراك الأساسي
