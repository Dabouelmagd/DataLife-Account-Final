...
DEFAULT_ACCOUNTS = [
    ...
    {"code": "139", "name": "أصول ضريبية مؤجلة", "name_en": "Deferred Tax Assets",
     "type": AccountType.ASSET, "category": AccountCategory.NON_CURRENT_ASSET, "parent_code": "13"},
    {"code": "1361", "name": "جاري الشركات التابعة والشقيقة", "name_en": "Intercompany Receivable",
     "type": AccountType.ASSET, "category": AccountCategory.RECEIVABLE, "parent_code": "13"},
    {"code": "142", "name": "مشروعات عقارية تحت التنفيذ", "name_en": "Real Estate Development in Progress",
     "type": AccountType.ASSET, "category": AccountCategory.NON_CURRENT_ASSET, "parent_code": "14"},
    {"code": "164", "name": "نقدية درج الكاشير — نقاط البيع", "name_en": "POS Cash Drawer",
     "type": AccountType.ASSET, "category": AccountCategory.CASH, "parent_code": "16"},
    {"code": "165", "name": "غطاء اعتمادات مستندية محتجز", "name_en": "Letter of Credit Cash Margin",
     "type": AccountType.ASSET, "category": AccountCategory.CURRENT_ASSET, "parent_code": "16"},
    {"code": "265", "name": "ضريبة الدخل المستحقة", "name_en": "Corporate Income Tax Payable",
     "type": AccountType.LIABILITY, "category": AccountCategory.CURRENT_LIABILITY, "parent_code": "25"},
    {"code": "266", "name": "ضريبة كسب العمل المستقطعة من المرتبات", "name_en": "Payroll Income Tax Withheld",
     "type": AccountType.LIABILITY, "category": AccountCategory.CURRENT_LIABILITY, "parent_code": "25"},
    {"code": "3361", "name": "مصروفات بوفيه وضيافة", "name_en": "Hospitality Expenses",
     "type": AccountType.EXPENSE, "category": AccountCategory.ADMIN_EXPENSE, "parent_code": "33"},
    {"code": "3362", "name": "مصروفات وقود ومواصلات", "name_en": "Fuel & Transport Expenses",
     "type": AccountType.EXPENSE, "category": AccountCategory.ADMIN_EXPENSE, "parent_code": "33"},
    {"code": "3363", "name": "مصروفات صيانة طارئة", "name_en": "Emergency Maintenance Expenses",
     "type": AccountType.EXPENSE, "category": AccountCategory.ADMIN_EXPENSE, "parent_code": "33"},
    {"code": "3364", "name": "خسائر رأسمالية (بيع واستبعاد أصول ثابتة)", "name_en": "Loss on Disposal of Fixed Assets",
    ...
    #    such as "under_collection": "233" that the chart did not have) ──
    {"code": "1311", "name": "شيكات مرتدة", "name_en": "Returned Cheques",
     "type": AccountType.ASSET, "category": AccountCategory.RECEIVABLE, "parent_code": "13"},
    {"code": "1312", "name": "عملاء أقساط مؤجلة — عقارات", "name_en": "Real Estate Instalments Receivable",
     "type": AccountType.ASSET, "category": AccountCategory.RECEIVABLE, "parent_code": "13"},
    {"code": "1313", "name": "عجز نقدية — ذمة الكاشير", "name_en": "Cashier Shortage Receivable",
     "type": AccountType.ASSET, "category": AccountCategory.RECEIVABLE, "parent_code": "13"},
    {"code": "1342", "name": "عهد عينية لدى الموظفين", "name_en": "Employee Custody Items",
     "type": AccountType.ASSET, "category": AccountCategory.CURRENT_ASSET, "parent_code": "13"},
    {"code": "1561", "name": "أصول حق الاستخدام", "name_en": "Right-of-Use Assets",
     "type": AccountType.ASSET, "category": AccountCategory.NON_CURRENT_ASSET, "parent_code": "11"},
    {"code": "1562", "name": "مجمع إهلاك أصول حق الاستخدام", "name_en": "Accumulated Depreciation — ROU",
     "type": AccountType.CONTRA_ASSET, "category": AccountCategory.NON_CURRENT_ASSET, "parent_code": "11"},
    {"code": "2141", "name": "حقوق الأقلية", "name_en": "Non-controlling Interest",
     "type": AccountType.EQUITY, "category": AccountCategory.EQUITY, "parent_code": "21"},
    {"code": "217", "name": "الاحتياطي العام", "name_en": "General Reserve",
     "type": AccountType.EQUITY, "category": AccountCategory.RESERVES, "parent_code": "21"},
    {"code": "2201", "name": "عمولات مبيعات مستحقة", "name_en": "Sales Commissions Payable",
     "type": AccountType.LIABILITY, "category": AccountCategory.CURRENT_LIABILITY, "parent_code": "22"},
    {"code": "224", "name": "مخصص خسائر ائتمانية متوقعة", "name_en": "Expected Credit Loss Allowance",
     "type": AccountType.CONTRA_ASSET, "category": AccountCategory.CURRENT_ASSET, "parent_code": "22"},
    {"code": "226", "name": "مخصص هبوط قيمة المخزون", "name_en": "Inventory Impairment Allowance",
     "type": AccountType.CONTRA_ASSET, "category": AccountCategory.CURRENT_ASSET, "parent_code": "22"},
    {"code": "227", "name": "مخصص قضايا والتزامات محتملة", "name_en": "Provision for Contingencies",
     "type": AccountType.LIABILITY, "category": AccountCategory.CURRENT_LIABILITY, "parent_code": "22"},
    {"code": "2301", "name": "جاري الشركات التابعة — دائن", "name_en": "Intercompany Payable",
     "type": AccountType.LIABILITY, "category": AccountCategory.CURRENT_LIABILITY, "parent_code": "23"},
    {"code": "2541", "name": "ضريبة التصرفات العقارية المستحقة", "name_en": "Real Estate Disposal Tax Payable",
     "type": AccountType.LIABILITY, "category": AccountCategory.CURRENT_LIABILITY, "parent_code": "25"},
    {"code": "2542", "name": "ضريبة توزيعات الأرباح المستحقة", "name_en": "Dividend Tax Payable",
     "type": AccountType.LIABILITY, "category": AccountCategory.CURRENT_LIABILITY, "parent_code": "25"},
    {"code": "2602", "name": "التزامات ضريبية مؤجلة", "name_en": "Deferred Tax Liabilities",
     "type": AccountType.LIABILITY, "category": AccountCategory.NON_CURRENT_LIABILITY, "parent_code": "25"},
    {"code": "2611", "name": "التزامات الإيجار — طويلة الأجل", "name_en": "Lease Liabilities — Non-current",
     "type": AccountType.LIABILITY, "category": AccountCategory.LONG_TERM_LIABILITY, "parent_code": "24"},
    {"code": "2612", "name": "التزامات الإيجار — الجزء الجاري", "name_en": "Lease Liabilities — Current",
     "type": AccountType.LIABILITY, "category": AccountCategory.CURRENT_LIABILITY, "parent_code": "25"},
    ...
    {"code": "3351", "name": "مصروف ضريبة الدخل الجارية", "name_en": "Current Income Tax Expense",
     "type": AccountType.EXPENSE, "category": AccountCategory.OPERATING_EXPENSE, "parent_code": "33"},
    {"code": "3352", "name": "مصروف الضريبة المؤجلة", "name_en": "Deferred Tax Expense",
     "type": AccountType.EXPENSE, "category": AccountCategory.OPERATING_EXPENSE, "parent_code": "33"},
    {"code": "3353", "name": "عجز نقدية مسموح به", "name_en": "Allowed Cash Shortage",
     "type": AccountType.EXPENSE, "category": AccountCategory.ADMIN_EXPENSE, "parent_code": "33"},
    {"code": "3371", "name": "عمولات فتح الاعتمادات المستندية", "name_en": "Letter of Credit Commissions",
     "type": AccountType.EXPENSE, "category": AccountCategory.OPERATING_EXPENSE, "parent_code": "32"},
    {"code": "3372", "name": "مصروفات شحن دولي", "name_en": "International Freight",
     "type": AccountType.EXPENSE, "category": AccountCategory.OPERATING_EXPENSE, "parent_code": "31"},
    {"code": "3373", "name": "مصروفات تأمين بحري", "name_en": "Marine Insurance",
     "type": AccountType.EXPENSE, "category": AccountCategory.OPERATING_EXPENSE, "parent_code": "31"},
    {"code": "3374", "name": "رسوم جمركية", "name_en": "Customs Duties",
     "type": AccountType.EXPENSE, "category": AccountCategory.OPERATING_EXPENSE, "parent_code": "31"},
    {"code": "3375", "name": "مصروفات تخليص جمركي وميناء", "name_en": "Customs Clearance & Port Charges",
     "type": AccountType.EXPENSE, "category": AccountCategory.OPERATING_EXPENSE, "parent_code": "31"},
    {"code": "3411", "name": "إهلاك أصول حق الاستخدام", "name_en": "ROU Depreciation",
     "type": AccountType.EXPENSE, "category": AccountCategory.ADMIN_EXPENSE, "parent_code": "33"},
    {"code": "3412", "name": "فوائد التزامات الإيجار", "name_en": "Lease Interest Expense",
     "type": AccountType.EXPENSE, "category": AccountCategory.OPERATING_EXPENSE, "parent_code": "32"},
    {"code": "3421", "name": "عمولات مندوبي المبيعات", "name_en": "Sales Commissions",
     "type": AccountType.EXPENSE, "category": AccountCategory.SELLING_EXPENSE, "parent_code": "34"},
    {"code": "3501", "name": "استبعاد إيرادات بين شركات المجموعة", "name_en": "Intercompany Revenue Elimination",
     "type": AccountType.EXPENSE, "category": AccountCategory.OPERATING_EXPENSE, "parent_code": "3"},
    {"code": "3502", "name": "استبعاد مشتريات بين شركات المجموعة", "name_en": "Intercompany Purchases Elimination",
     "type": AccountType.EXPENSE, "category": AccountCategory.OPERATING_EXPENSE, "parent_code": "3"},
    {"code": "418", "name": "إيرادات المختبر والتحاليل", "name_en": "Laboratory Revenue",
     "type": AccountType.REVENUE, "category": AccountCategory.OPERATING_REVENUE, "parent_code": "41"},
    {"code": "419", "name": "إيرادات الأشعة والتصوير", "name_en": "Radiology Revenue",
     "type": AccountType.REVENUE, "category": AccountCategory.OPERATING_REVENUE, "parent_code": "41"},
    {"code": "420", "name": "إيرادات الصيدلية", "name_en": "Pharmacy Revenue",
     "type": AccountType.REVENUE, "category": AccountCategory.OPERATING_REVENUE, "parent_code": "41"},
    {"code": "4111", "name": "إيرادات بيع الوحدات العقارية", "name_en": "Real Estate Unit Sales",
     "type": AccountType.REVENUE, "category": AccountCategory.OPERATING_REVENUE, "parent_code": "41"},
    {"code": "4121", "name": "إيرادات مبيعات نقاط البيع", "name_en": "POS Sales Revenue",
     "type": AccountType.REVENUE, "category": AccountCategory.OPERATING_REVENUE, "parent_code": "41"},
    {"code": "4231", "name": "إيراد زيادة النقدية", "name_en": "Cash Overage Income",
     "type": AccountType.REVENUE, "category": AccountCategory.OTHER_REVENUE, "parent_code": "42"},
    {"code": "4301", "name": "أرباح غير محققة — مخزون بين الشركات", "name_en": "Unrealised Intercompany Profit",
     "type": AccountType.REVENUE, "category": AccountCategory.OTHER_REVENUE, "parent_code": "43"},
    {"code": "4351", "name": "إيراد الضريبة المؤجلة", "name_en": "Deferred Tax Income",
     "type": AccountType.REVENUE, "category": AccountCategory.OTHER_REVENUE, "parent_code": "42"},
]
