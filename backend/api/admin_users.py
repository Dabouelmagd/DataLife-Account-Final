...
async def get_all_permissions(authorization: Optional[str] = Header(None)):
    ...
    permissions = [
        ...
        {"id": "projects", "name": "Projects", "name_ar": "المشاريع"},
        {"id": "analytics", "name": "Analytics", "name_ar": "التحليلات"},
        {"id": "settings", "name": "Settings", "name_ar": "الإعدادات"},
        {"id": "users", "name": "Users Management", "name_ar": "إدارة المستخدمين"},
        {"id": "approvals", "name": "Approvals", "name_ar": "الموافقات"},
        {"id": "reports", "name": "Reports", "name_ar": "التقارير"},
        {"id": "inventory", "name": "Inventory", "name_ar": "المخزون"},
        {"id": "admin", "name": "Admin Panel", "name_ar": "لوحة الإدارة"},
        {"id": "subscriptions", "name": "Subscriptions", "name_ar": "الاشتراكات"},
        {"id": "companies", "name": "Companies", "name_ar": "الشركات"},
        {"id": "audit_logs", "name": "Audit Logs", "name_ar": "سجل التدقيق"},
        {"id": "system_settings", "name": "System Settings", "name_ar": "إعدادات النظام"},
        {"id": "billing", "name": "Billing", "name_ar": "الفواتير"},
        {"id": "support", "name": "Support", "name_ar": "الدعم"},
    ]
    return permissions
