...
ACC = {
    ...
    "petty_exp": "3366",  # مصروفات نثرية (336 is legal & professional fees)
    "buffet":    "3361",  # بوفيه وضيافة
    "fuel":      "3362",  # وقود ومواصلات
    "maint":     "3363",  # صيانة طارئة
    "misc_exp":  "3366",  # مصروفات نثرية ومتنوعة
...
EXPENSE_ACCOUNTS = {
    ...
    "stationery":  ("3366", "مصروفات قرطاسية ومطبوعات"),
    "cleaning":    ("3366", "مصروفات نظافة"),
    "misc":        ("3366", "مصروفات نثرية متنوعة"),
